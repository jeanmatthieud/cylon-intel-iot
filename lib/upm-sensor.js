...
var upmDevices = {
  ...
  "upm-mma7660": {
    init: function() {
      ...
      var accel = new u.MMA7660(u.MMA7660_I2C_BUS,
                           u.MMA7660_DEFAULT_I2C_ADDR);

      function intp() {
        var val = u.new_intp();

        // define dynamic "getter" for intp values:
        function get() { return u.intp_value(this); }
        Object.defineProperty(val, "value", { get: get });

        return val;
      }

      function floatp() {
        var val = u.new_floatp();

        // define dynamic "getter" for float values:
        function get() { return u.floatp_value(this); }
        Object.defineProperty(val, "value", { get: get });

        return val;
      }

      var x = floatp(), y = floatp(), z = floatp();
      accel._getAcceleration = accel.getAcceleration;
      accel.getAcceleration = function() {
        accel._getAcceleration(x, y, z);
        return {x: x.value, y: y.value, z: z.value};
      };

      var rawX = floatp(), rawY = intp(), rawZ = intp();
      accel._getRawValues = accel.getRawValues;
      accel.getRawValues = function() {
        accel._getRawValues(rawX, rawY, rawZ);
        return {x: rawX.value, y: rawY.value, z: rawZ.value};
      };
    ...
    commands: ["getRawValues", "getAcceleration",
               ...
               "tiltTap", "tiltShake", "setModeStandby",
               "setSampleRate", "setModeActive"]
  },
  "upm-otp538u": {
  ...
  "upm-ttp223": {
    init: function(pin) {
      var u = require("jsupm_ttp223");
      return new u.TTP223(pin);
    },
    commands: ["isPressed", "name"]
  },
  "upm-yg1006": {
    init: function(pin) {
